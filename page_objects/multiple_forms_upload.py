...
class Test_multiple_form_upload(unittest.TestCase):
    ...
    def click_a_groups_tab(self):
        ...
        wait.until(EC.visibility_of_element_located((By.XPATH, self.group_tab)))
    ...
    def upload_and_validate_b_multiple_forms(self):
        ...
        no_of_forms = image_data.__len__()                      # Fetches no.of image paths in image_path json file

        for i in range(no_of_forms):
            time.sleep(3)
            # Clicks on Automation Group
            # Please change the xpath of Group while executing the script in your local
            ...
            # Please change the image paths in image_path while executing the script in your local
            ...
            file1 = open(self.expected_json_data, 'r', encoding="utf8")           # Opens json_file_path json file
