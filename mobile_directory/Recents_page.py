...
driver.find_element_by_xpath("//*[@label='Recents']").click()
time.sleep(1)
driver.implicitly_wait(50)
driver.find_element_by_xpath("(//*[@label='Health Check Scan'])[1]").click()
time.sleep(1)
driver.implicitly_wait(50)
driver.find_element_by_xpath("//*[contains(@label,'BMI')]").click()
time.sleep(1)
driver.implicitly_wait(50)
abc = driver.find_elements_by_xpath("(//UIView").text()
print(abc)
