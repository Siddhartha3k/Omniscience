...
traslate_toogle = driver.find_element_by_xpath("//*[@label='Translate Results']")
driver.execute_script('mobile: scroll', {"element": traslate_toogle, "toVisible": True})
time.sleep(2)
driver.find_element_by_xpath("//*[@label='Translate Results']/following::*[2]").click()
time.sleep(2)
...
time.sleep(2)
driver.implicitly_wait(100)
result_header = driver.find_elements_by_xpath("//*[@label='Physical']")
if len(result_header) > 0:
    print("Results Translated")
else:
    print("Results not translated")
