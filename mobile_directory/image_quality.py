...
time.sleep(2)
driver.find_element_by_xpath("//*[contains(@label,'Image Quality:')]").click()
time.sleep(1)
driver.find_element_by_xpath("//*[@label='Low']").click()
time.sleep(2)
...
driver.find_element_by_xpath("//*[contains(@label,'Image Quality:')]").click()
time.sleep(1)
driver.find_element_by_xpath("//*[@label='Medium']").click()
time.sleep(2)
driver.find_element_by_xpath("//*[@name='Home']").click()
driver.find_element_by_xpath("//*[@name='Capture Form']").click()
time.sleep(1)
