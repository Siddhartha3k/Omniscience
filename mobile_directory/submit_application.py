...
driver.find_element_by_xpath("//*[@name='Submit Case']").click()
time.sleep(1)
driver.implicitly_wait(100)
driver.find_element_by_xpath("//*[@label='Health Check Form']").click()
driver.find_element_by_accessibility_id("OK").click()
time.sleep(1)
...
driver.implicitly_wait(100)
driver.find_element_by_xpath("//*[@label='Disclosure Questions']").click()
time.sleep(1)
driver.implicitly_wait(100)
driver.find_element_by_xpath("//*[@value='How old are you?']").send_keys("7")
driver.implicitly_wait(100)
driver.find_element_by_xpath("//*[@label='Done']").click()
