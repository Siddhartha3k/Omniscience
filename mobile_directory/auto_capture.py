...
time.sleep(2)
driver.find_element_by_xpath("//*[@label='Use Auto-Capture']/following::*[2]").click()
time.sleep(2)
...
time.sleep(2)
driver.implicitly_wait(100)
driver.find_element_by_xpath("//*[@label='Slow Down Auto-Capture']/following::*[2]").click()
time.sleep(2)
driver.find_element_by_xpath("//*[@name='Home']").click()
driver.find_element_by_xpath("//*[@name='Capture Form']").click()
time.sleep(3)
